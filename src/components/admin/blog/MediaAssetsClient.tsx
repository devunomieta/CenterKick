    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative group">
           ...
           />
           <button className="bg-black text-white px-4 md:px-8 py-4 rounded-2xl font-bold text-xs tracking-wide transition-all flex items-center gap-3 shadow-xl hover:bg-[#b50a0a] group-hover:-translate-y-0.5">
      ...
      <div className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center justify-between gap-6">
        <div className="relative flex-1">
          ...
          <input 
            ...
            className="w-full pl-16 pr-8 py-4 bg-gray-50 border-none rounded-2xl text-xs font-bold tracking-wide focus:ring-2 focus:ring-[#b50a0a] transition-all text-black placeholder:text-gray-300"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div key={asset.id} className="group relative aspect-square bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all hover:-translate-y-1">
              ...
              <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center gap-4 p-6 backdrop-blur-[2px]">
                <button 
                  ...
                  className="w-full py-3 bg-white text-black rounded-xl text-xs font-bold tracking-wide flex items-center justify-center gap-2 hover:bg-[#b50a0a] hover:text-white transition-all transform translate-y-4 group-hover:translate-y-0 duration-300"
                >
                ...
                <button 
                  ...
                  className="w-full py-3 bg-red-600/20 text-red-500 border border-red-500/20 rounded-xl text-xs font-bold tracking-wide flex items-center justify-center gap-2 hover:bg-red-600 hover:text-white transition-all transform translate-y-4 group-hover:translate-y-0 delay-75 duration-300"
                >
              ...
              <div className="absolute top-4 left-4">
                <div className="bg-black/50 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10">
                   <p className="text-[7px] font-bold text-white tracking-wide truncate max-w-full max-w-[100px]">
              ...
              <div className="absolute bottom-0 inset-x-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
                  <p className="text-xs font-bold text-white truncate tracking-wide drop-shadow-lg">
                    {asset.filename}
                  </p>
              </div>
          </div>
        ...
        {filteredAssets.length === 0 && (
          <div className="col-span-full py-32 text-center bg-gray-50 rounded-[3rem] border border-dashed border-gray-200">
             ...
             <p className="text-sm font-bold tracking-wide text-gray-400">No assets matching your search.</p>
          </div>
        )}
      </div>
    </div>
