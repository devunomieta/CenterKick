...
export function AboutClient({ content }: AboutClientProps) {
   const hero = content?.hero || { 
     subtitle: "Who We Are", 
     title: "About Us", 
     description: "A modern football media, marketing, and talent exposure platform built to empower footballers at all levels." 
   };
   const mission = content?.mission || {
     title: "Empowering Talent At All Levels",
     description: "To empower footballers at all levels by providing them with a professional and user-friendly e-profile platform that showcases their skills and experience."
   };
   const vision = content?.vision || {
     title: "The Leading Sports Marketing Agency",
     description: "To become the leading Sports Marketing Agency in the football industry, recognised for innovative solutions and personalised services."
   };
            ...
            <div className="relative w-full h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
               ...
               <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center mt-20">
                  <div className="inline-flex items-center gap-3 bg-white/5 backdrop-blur-md border border-white/20 rounded-full px-5 py-2 mb-8 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
                     ...
                     <span className="text-white font-bold text-xs uppercase tracking-widest drop-shadow-md">{hero.subtitle}</span>
                  </div>
