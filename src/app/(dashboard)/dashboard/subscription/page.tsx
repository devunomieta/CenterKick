    ...
    <>
      ...
      <div className="max-w-full max-w-[1000px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-100 pb-8">
          ...
          <div className={`${plan.status === 'Active' ? 'bg-green-50 border-green-100' :
            ...
            <div className="text-left">
              ...
              <div className="flex items-center gap-3">
                <p className={`text-xl font-bold tracking-tighter ${plan.status === 'Active' ? 'text-green-600' :
            ...
            <div className={`border-l pl-6 ${plan.status === 'Active' ? 'border-green-200' :
                plan.status === 'Pending Approval' ? 'border-blue-200' :
                  'border-red-200'
              }`}>
              <div className="flex flex-col gap-0.5">
                <span className={`text-lg font-bold ${plan.status === 'Active' ? 'text-gray-900' : 'text-[#b50a0a]'
                  }`}>{plan.price}</span>
              ...
              <div className="space-y-8 animate-in fade-in duration-500">
                ...
                <div className="relative group overflow-hidden bg-white rounded-[40px] border border-gray-100 shadow-sm p-4 md:p-8 md:p-12">
                  ...
                  <div className="flex flex-col gap-10 md:p-8 relative z-10">
                    ...
                    {plan.status !== 'Unverified' && (
                      <div className={`p-6 rounded-3xl border ${plan.status === 'Pending Approval' ? 'bg-blue-50 border-blue-100' :
                      ...
                      >
                        <div className="space-y-1">
                          <div className="flex items-center gap-3">
                            ...
                            <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold tracking-wide ${tx.status === 'confirmed' ? 'bg-green-50 text-green-700 border border-green-100' :
              ...
              <div className="p-10 pb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 mb-8 text-left">
                  ...
                  <div className="space-y-1">
                    ...
                    <div>
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold tracking-wide ${inspectTransaction.status === 'confirmed' ? 'bg-green-50 text-green-700 border border-green-100' :
