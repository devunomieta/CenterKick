...
import { Mail, AlertCircle, CheckCircle2, ArrowRight, Chrome } from "lucide-react";
                  ...
                  <div className="mt-12 text-center">
                     ...
                     >
                        {mode === 'login' ? (
                           ...
                           <>Already have an account? <span className="text-[#a20000] ml-2">Login Now</span></>
                        )}
                     </button>
                  </div>
               </div>
...
export default function LoginPage() {
   return (
      <div className="min-h-screen bg-white">
         <Navbar />
         <Suspense fallback={<div className="pt-40 text-center font-black uppercase tracking-widest animate-pulse text-[#a20000]">Initializing Secure Arena...</div>}>
            <LoginContent />
         </Suspense>
         <Footer />
      </div>
